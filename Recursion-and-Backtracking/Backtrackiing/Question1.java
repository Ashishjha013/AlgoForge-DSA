// Question 1:
// Flood Fill
// Implement the flood fill algorithm using recursion.

// hints: You can use a 2D array to represent the grid and a boolean 2D array to keep track of visited cells. The function should explore all four possible directions (up, down, left, right) from the current cell and mark cells as visited to avoid cycles.

public class Question1 {
  public static void floodFill(int row, int col, int[][] mat, boolean[][] visited, int n, int m, String psf) {
    if (row < 0 || col < 0 || row >= n || col >= m
        || mat[row][col] == 1 || visited[row][col] == true) {
      return;
    }
